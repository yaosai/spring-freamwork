...
public abstract class AbstractAdvisorAutoProxyCreator extends AbstractAutoProxyCreator {
	...
	protected Object[] getAdvicesAndAdvisorsForBean(
		...
		if (advisors.isEmpty()) {
			//若无法找到对应的增强器便返回DO_NOT_PROXY(null)
			return DO_NOT_PROXY;
		}
	...
	/**
	 * Find all eligible（合适的） Advisors for auto-proxying this class.
	...
	protected List<Advisor> findEligibleAdvisors(Class<?> beanClass, String beanName) {
		//返回所有供选择的增强器
		//因目前分析的AOP是基于注解的，故findCandidateAdvisors真正的逻辑是委托给AnnotationAwareAspectJAutoProxyCreator类的
	...
	/**
	 * Find all candidate(供选择的) Advisors to use in auto-proxying.
